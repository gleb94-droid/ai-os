...
type: person
---
# 👤 Dima (B2B partner — dog business)

Runs a full dog business (דימה "dog trainer") — **training · service boarding · training boarding · pet food & equipment store**. Found Gleb via the dog-print content.

- **2026-06-30 deal:** wants **3 gift bundles** for his clients:
  - **Basic** — boarding guests (cheap/volume)
  - **מדים / uniform** — training sessions
  - **Premium** — training-boarding graduates
- **🔁 Cross-referral partnership:** he refers clients to Gleb, Gleb refers jobs to him. Floated a coupon code ("כלבהטובה10").
- **🆕 2026-07-01 — 3-bundle menu designed** (all personalized with the client's dog + a "graduate" angle: dog name + *בוגר אילוף 2026 / עבר בהצטיינות*):
  - **🐾 Basic ₪59** (boarding guests) — personalized **dog bandana** (Zikit #7630, blank **₪9**, S/M/L/XL) + **fridge magnet** of the dog (magnet blank ₪4.8). Blanks ~₪14 → healthy margin.
